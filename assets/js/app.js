...
export const updateWeather = function(lat,lon){
    ...
    fetchData(url.currentWeather(lat,lon),function(currentWeather){
        ...
        // whole different thing, error is not here
        ...
        for(let i = 7, len = forecastList.length; i<len ;i+=8){
            ...
            <div class="icon-wrapper">
                        ...
                        <img src="assets/images/weather_icons/${icon}.png" width="36" height="36" alt="${description}" class="weather_icon" title=${description}>
                    ...
                    <p class="label-1">${module.weekDayNames[date.getUTCDay()]}
                    </p>
            `;
